...
- **The nightly fact pack states its own evidence shape** (2026-09-01, BD-80…84).
...
owed. Recorded as **BD-80 … BD-84** in `docs/RESEARCH_WAREHOUSE_BUILD_DECISIONS.md`
...
**1. Episodes beside rows (BD-80), and the measurement changed the conclusion.** Every
...
denominator a reader comparing cells actually needs. BD-80 records that the follow-up
must be a cross-cell floor, not the per-cell swap first assumed.

**2. The eligible block leads (BD-81).** Two blocks: eligible whole and sorted as
...
**3. Non-trade roles excluded and named (BD-82).** A small explicit role map -
...
**4. Coverage is published (BD-83).** New `research_warehouse/outcome_coverage.py`:
