...
- Phase 0.5 trader refinement packets (promoted 2026-08-15): `docs/AUTO_MODES_AND_QUIET_HOURS_PLAN.md` (R1 — **BUILT 2026-08-15** on `phase05-r1-auto-modes-quiet-hours`, live proof owed), `docs/M5_FOCUS_GATING_AND_STRENGTH_BOARD_PLAN.md` (R2 — **BUILT 2026-08-15** on `phase05-r2-focus-gating-strength-board`, live proof owed), `docs/SWING_QUALITY_AND_FEEDBACK_PLAN.md` (R3, incl. the completed after-close scan investigation), `docs/DESK_CHART_UNIFICATION_PLAN.md` (R4), `docs/M5_SIGNAL_ENGINES_PLAN.md` (R5). **R3–R5 wait for an explicit trader go**: the 2026-08-15 redirects that started R1 and R2 ahead of P0.7 were given packet by packet and do not carry forward.
