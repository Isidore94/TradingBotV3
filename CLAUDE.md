...
- Phase 0.5 trader refinement packets (promoted 2026-08-15; **R3–R6 authorized by the trader's 2026-08-15 weekend redirect**, all building on the single consolidated branch `testing-week-2026-08-17`): `docs/AUTO_MODES_AND_QUIET_HOURS_PLAN.md` (R1 — **BUILT**, 4 live proofs owed), `docs/M5_FOCUS_GATING_AND_STRENGTH_BOARD_PLAN.md` (R2 — **BUILT**, 4 live proofs owed), `docs/SWING_QUALITY_AND_FEEDBACK_PLAN.md` (R3 — **CLOSED 2026-08-16**; §4.3.5 volume-thrust normalization deferred by trader decision; shadow week owed), `docs/DESK_CHART_UNIFICATION_PLAN.md` (R4 — **BUILT 2026-08-16**, §8 exit gate owed), `docs/M5_SIGNAL_ENGINES_PLAN.md` (R5 — **§2 + §5 built**, §3/§4 wiring next, LRSI cross first; its §8.1 records the `M5_SIGNAL_TAG` lane decision), plus R6 (not started), R7 and R8 (**BUILT**, live gates owed). **`CURRENT_CHECKPOINT.md` opens with a weekend summary and the exact resume point — read that first.** Phases 1–7 remain NOT authorized.
