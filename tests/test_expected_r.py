...
class ProvenQualityScoreTests(unittest.TestCase):
    ...
    def test_proven_good_beats_unknown_beats_proven_loser(self):
        good = compute_proven_quality_score(
            static_points=120, win_rate=0.60, profit_factor=2.0, closed_samples=25, policy="pqs_v1"
        )
        unknown = compute_proven_quality_score(static_points=260, policy="pqs_v1")
        loser = compute_proven_quality_score(
            static_points=545, win_rate=0.33, profit_factor=0.6, closed_samples=12, policy="pqs_v1"
        )
    ...
    def test_structure_is_only_a_tiebreaker(self):
        ...
        modest = compute_proven_quality_score(
            static_points=100, win_rate=0.55, profit_factor=1.5, closed_samples=20, policy="pqs_v1"
        )
        stacked = compute_proven_quality_score(
            static_points=500, win_rate=0.55, profit_factor=1.5, closed_samples=20, policy="pqs_v1"
        )
    ...
    def test_freshness_decays_evidence_not_structure(self):
        fresh = compute_proven_quality_score(
            static_points=100, win_rate=0.6, profit_factor=2.0, closed_samples=25, freshness=1.0, policy="pqs_v1"
        )
        stale = compute_proven_quality_score(
            static_points=100, win_rate=0.6, profit_factor=2.0, closed_samples=25, freshness=0.5, policy="pqs_v1"
        )
