...
def test_tier_partition_demotes_negative_expected_r_from_s_to_a():
    from master_avwap_lib import legacy

    good = {"symbol": "AAA", "side": "SHORT", "score": 200, "expected_r": 0.10}
    # high static score but clearly-negative Expected-R -> must not headline S tier
