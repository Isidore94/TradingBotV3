...
Full suite on the merged tip: **BASELINE_PENDING_LEAD**. Live gate **#162** owed, and the trader's `--apply` with it. Long form: DESK_INTERNALS "TJ-9Q".
