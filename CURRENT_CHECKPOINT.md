...
| Working branch | `main`; the WISHLIST 11 build is `8baf643b` on top of `7635d09a`, pushed to origin. `WISHLIST.md` stays the trader's uncommitted working copy (its item 11 status line was updated in place, unstaged). No branch switch, live repair or desk restart. |
