...
| Last verified baseline | **PENDING the lead's full suite on the integration tip `161e905c`** (TJ-10 + TJ-14B) - the number goes in here. Before it: **9,536 passed, 14 skipped, 72 subtests, 2 failed on the TJ-10 merge `57b44ca9`** - the known flake `test_ws_10a_scan_freshness` and `test_fixture_contract` (the TJ-10 fixture moved in `3e52d94f`, re-run green with the AI lock free) - and **9,396 passed, 14 skipped, 72 subtests, 1 failed on `86c64f96`** (everything live + TJ-13B + TJ-9Q), nightly AI lock free, 2026-09-20 06:57 PDT; ruff clean, smoke 7/7, source selftest 92/92, which TJ-14B takes to **93/93**. |
| Frozen exe | **Rebuilt and verified 2026-09-16: source 87/87 and frozen 87/87** with the `(frozen)` stamp. The desk runs from SOURCE. |
| Desk | **UP since 2026-09-20 07:14 PDT on `acaa13c0`** (TJ-13B + TJ-9Q), started clean after the 06:11 close; `last good` is `acaa13c0`. The next fast-forward takes TJ-10 and TJ-14B; IB is not logged in (TWS is the trader's). |
