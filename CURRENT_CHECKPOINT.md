...
Recorded, not repaired: a rebuilt row's `m5_as_of` is Pacific-zoned where the live card's is Eastern - the same moment, compared with `astimezone` and never as a string; `read_unchanged` now returns `{"ok", "entries": [...]}`; `internals_bars_at` has no production caller yet (a capability until TJ-10 / TJ-16 call it). Items 2-5 are TJ-14B. Full suite on the merged tip: **BASELINE_PENDING_LEAD**. Live gate #159's first clause owed.
