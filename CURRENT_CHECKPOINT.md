...
| Last verified baseline | **`claude/g7-speed-pass` (G7 fix round), 2026-09-07 later, in the builder's worktree, nightly AI lock FREE (probed): `pytest tests/ -q` with NOTHING DESELECTED: 7276 passed, 3 skipped, 72 subtests passed, ZERO failures, exit 0, 7 min 29 s; ruff clean; smoke 7/7; source selftest 74/74.** Previous: same branch before the fix round, 7273 passed, exit 0; before that `lead/merge-g` at `0a1478e0` (G5 after its fix round), 7255 passed, exit 0. |
