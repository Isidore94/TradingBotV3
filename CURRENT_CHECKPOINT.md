...
| Last verified baseline | **9,807 passed, 14 skipped, 72 subtests, 0 failed on `d929e34f`** (live + TJ-16 + TJ-4), AI lock free, 16:52 PDT; ruff clean, smoke 7/7, source selftest **95/95**. **TJ-12 suite PENDING the lead** on `843a3f02`; on that tip the reviewer measured 102 `test_tj12_*` + 766 neighbours passed, ruff clean, source selftest **96/96**. |
