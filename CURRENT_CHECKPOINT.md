...
deselected - 6511 passed, 1 failed (the `== 3` above), 1 skipped, 72 subtests
passed, 7 min 02 s, process exit 1 for that one test alone. `ruff` clean. `smoke_check.py` 7/7.
