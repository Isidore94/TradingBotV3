...
| Last verified baseline | **TJ-2 integration: 8,824 passed, 14 skipped, 72 subtests, 0 failed, pytest exit 0 (2026-09-18); ruff clean, smoke 7/7, source selftest 92/92.** |
...
| 158 | **The night serves the trader first (TJ-13, PLANNED)** - the day story finishes before 23:30 Pacific, the morning brief lists no membership-only name, `ai_summary` is synthesized or fails fast and runs Saturday night only, no ledger row starts between 06:00 and 22:00 Pacific on any day, and the week story's ledger row names the large local model. | trader, first week after TJ-13 |
