...
**Verification** (targeted; the lead runs the full suite at merge): 21/21 new;
1,553 passed over `-k "ai or like_link or brief or warehouse or research"`, exit 0;
`ruff check .` clean. **No packaging trigger**: no new dependency, no new non-`.py`
