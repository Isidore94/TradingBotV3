...
| 10D Market Journal story + thesis | `WS-10D` / `claude/ws-10d-market-story` | PACKET (after TM) | Steps 1-2 deterministic (daily story, active-thesis view); step 3 rollups through the existing runner slot. Wave 3. |
...
| 10F Daily Recap | `WS-DR` / `claude/ws-dr-daily-recap` | PACKET (after SX, 5B, ENV) | Session reader over durable stores first, then the four views. Wave 2/3. |
| 10G one Watchlist tab | `WS-WL` / `claude/ws-wl-watchlist-tab` | PACKET (after 5D, SX, 10B) | Wave 3. |
