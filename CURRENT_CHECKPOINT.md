...
| 3 EF1 exit frameworks by family | `WS-EF1` / `claude/ws-ef1-exit-by-family` | PACKET | Second export + family picker on the Exit frameworks tab. legacy.py export seam only - the EF1 prompt is the recorded yes. |
