...
| 8 Setups star / X reflect the day's decisions | `WS-SX` / `claude/ws-sx-star-x` | BUILT locally 813d51ce on origin/claude/ws-sx-star-x-build (builder killed by the usage cap mid-suite, resumed 19:35 PT) | Both marks when both facts hold. Presentation only. |
