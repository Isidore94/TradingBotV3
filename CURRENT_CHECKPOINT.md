...
- **Outcomes for 2026-08/09 (BD-98).** The nightly never re-simulates a terminal
  ...
  next scan; 6,850 occurrences over 1,715 symbols. Buckets it does not reach are
  named in its report and in `outcome_bucket_coverage.jsonl`; a second run picks
  them up. Gate #56's last clause closes when every bucket has a
  `outcomes_recompute-bNN` firing.
