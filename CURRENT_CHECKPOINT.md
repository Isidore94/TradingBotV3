...
| 10F Daily Recap | `WS-DR` / `claude/ws-dr-daily-recap` | PACKET; tester running (third cap kill ~09:45 PT killed the first; respawned 10:50) | Session reader over durable stores first, then the four views. Wave 2/3. |
