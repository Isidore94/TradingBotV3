...
- **In flight:** the plan to 8/10 on every goal (`TODO.md`, trader's go 2026-09-25).
  **Phase 1 is done and waits for the trader's merge:** branch `claude/p8-phase1-2026-09-25`
  (P1 stop backfill, P2 mentor stop first + bulk confirm, P3 import retry + Health, P4
  night fixes; four reviewers GO). Phase 2 (P5, P6) and Phase 3 (P7, P9) are building on
  top of it. Each phase merges after reviewer GO, full suite and frozen selftest.
...
- **Last full suite:** 2026-09-25 Phase 1 branch: 11,940 passed, 3 known red
  (`test_tj17d_chosen_change.py`). Ruff clean, smoke 7/7, selftest 104/104 source and frozen.
