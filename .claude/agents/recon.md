...
Read `MEMORY.md` (routing only) with these instructions; once the question is in scope,
...
and cite file, tag and date. You never edit memory; report a proposed, sourced
