...
AVWAPE_TO_FIRST_DEV_MIN_SESSIONS_AFTER_GAP = 15
...
def fetch_earnings_for_date(date_str: str):
    ...
    try:
        ...
        _record_shared_nasdaq_rows_safely(rows if isinstance(rows, list) else [], date_str)
