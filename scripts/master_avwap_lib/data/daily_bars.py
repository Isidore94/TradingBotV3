...
expose_legacy_names(
    ...
    (
        ...
        "DAILY_BAR_SOURCE_UNKNOWN",
        "DAILY_BAR_STORE_COLUMNS",
        "DAILY_BAR_PROVENANCE_COLUMNS",
        "DAILY_BAR_UNIT_SHARES",
        "DAILY_BAR_UNIT_LOTS_RTH",
        "DAILY_BAR_UNIT_UNKNOWN",
        "daily_bar_provenance_for_source",
        "daily_bars_schema_version",
        "_apply_daily_bar_provenance",
        "_write_daily_bar_parquet",
