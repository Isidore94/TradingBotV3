...
# S7 shadow sidecar: the four shadow setup engines' events; `m5_shadow_setups` is the only writer.
M5_SHADOW_SETUPS_FILE = RUNTIME_DATA_DIR / "m5_shadow_setups.jsonl"
