...
# it is given.
# Left to right: the chart column, the M5 alert bar (trader, 2026-08-27 - a
# list of intraday alerts between the chart and the setups), the setups. The
# bar's share comes out of the setups' side so the chart column keeps its lead.
DESK_SPLIT_NARROW = (52, 7, 41)
DESK_SPLIT_WIDE = (58, 6, 36)
