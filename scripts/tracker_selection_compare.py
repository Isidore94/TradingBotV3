...
README_TEXT = (
    "Packet ST4.5, 2026-09-06; the decision it was built for was taken on "
    "2026-09-06 and is decision 0019. THE DEFAULT IS NOW `first_actionable_v2` "
    "(packet ST7, 2026-09-07) - it is the arm labelled v2 below and it is what "
    "the desk runs. `closed_first_v1` is the OLD arm: what the desk ran until "
    "2026-09-06, still selectable by name and reproduced byte for byte by "
    "`tests/fixtures/st4_family_rows_golden.csv`. This file stays EVIDENCE and "
    "decides nothing. v2 fixes the graded episode before its outcome is known "
    ...
    "Nothing here promotes anything: the flip changed which observation of a "
    "thesis is graded on an evidence surface, and no detector, alert, "
    "watchlist, Focus entry, review-queue item or review_policy.json is "
    "reachable from it. "
