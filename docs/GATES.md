...
- #220 Night journal import (P1-3 3d): after the next weeknight, Health's top line shows `journal import: last success <session>, last error ...`; a night that met "Statement could not be generated/retrieved" logs "IBKR Flex not ready ... retry" in the AI jobs log and ends `ok` or fails only after the waits [trader + lead]
