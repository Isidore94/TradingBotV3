...
- #233 Wider open sweep (P1-5 5c): the next morning's Auto Pilot log says `Watchlists built from N names` with N near universe_all.txt's size (about 1,400+, not 603); your typed longs/shorts are still in longs.txt/shorts.txt after the build, and at most 40 auto names per side were added [trader + lead]
