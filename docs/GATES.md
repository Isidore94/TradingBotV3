...
- #215 Econ morning brief: with the Mentor on, the first desk open of a session shows "Today's news & econ" (today's timed events in ET and PT, the week); after pasting today's brief it says "from today's brief"; a 10:00 ET release gives a desk toast + beep at 09:30 and 10:00 ET in DESK, a phone push in AWAY/EVENING, and a desk restart does not repeat them; after the next night run the ledger has an `econ_brief` row [trader]
