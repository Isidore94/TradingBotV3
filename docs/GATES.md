...
- #215 Movers IB scanner: the Movers board fills within 10 min of the open and its status line shows `ib_scanner`; trading_bot.log has no `Movers chunk ... dictionary changed size` and no `stuck` line [trader + lead]
