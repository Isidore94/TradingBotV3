...
- #243 Three-axis read (P2-8 8a): Research > Master AVWAP Market Prep shows `Market read (from <last close>): SPY ... · breadth ... · internals ...` with no desk lag; next evening Day Review's `market read right / wrong` tile shows a count and its tooltip names each axis's verdict [trader]
