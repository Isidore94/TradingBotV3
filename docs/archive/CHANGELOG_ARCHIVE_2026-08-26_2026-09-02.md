# Changelog archive — revision history 2026-08-26 to 2026-09-02

Historical revision entries moved out of [`CHANGELOG.md`](../CHANGELOG.md) on
2026-09-03 by the F1 docs packet: `Recent changes` had grown to 3,830 lines against
its own rule of holding the last two build days. **This file is evidence, not
authority.** What currently exists is the `Current implemented inventory` section of
`CHANGELOG.md`, and what remains is `plan.md`.

Entries are newest first, run from 2026-09-02 back to 2026-08-26, and are reproduced
verbatim (the 2026-09-02 entries were moved on 2026-09-05 by the repo cleanup). The earlier archive is
[`CHANGELOG_ARCHIVE_2025-11_2026-08-19.md`](CHANGELOG_ARCHIVE_2025-11_2026-08-19.md).
