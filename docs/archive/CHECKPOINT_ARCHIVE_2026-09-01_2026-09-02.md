# Checkpoint archive — dated entries for 2026-09-01 and 2026-09-02

The working record moved out of [`CURRENT_CHECKPOINT.md`](../../CURRENT_CHECKPOINT.md) on
2026-09-05 (repo cleanup), when the active file held 165 KB of dated entries from five
days and its archive rule ("older than the oldest open gate") could never fire. The active
file now keeps the last three build days. **This file is evidence, not authority**: an
open gate is open because the active checkpoint's gates tables list it, and every entry
here is reproduced verbatim, newest first (22 entries, Phase 0.13 packets P0-P10, the
review rounds R1-R3, Phase 0.14 packets V1-V3 and round R4 Part A).
