# Changelog archive — revision history to 2026-08-19

Historical revision entries moved out of [`CHANGELOG.md`](../CHANGELOG.md) on
2026-08-27. **This file is evidence, not authority.** It records how the system got
here; what currently exists is the `Current implemented inventory` section of
`CHANGELOG.md`, and what remains is `plan.md`.

The labels keep their strict meanings: `IMPLEMENTED` means code exists, `GREEN` means
deterministic tests pass, `LIVE_VALIDATED` requires real-session evidence, and
`PROMOTED` requires an explicit champion decision.

Entries are newest first, run from 2026-08-19 back to the initial system in
2025-11, and are reproduced verbatim.
...
# Dated build entries — 2026-08-25 back to 2026-08-16

Moved out of `CHANGELOG.md`'s `Current implemented inventory` on 2026-08-28. That
section had become 94% dated narrative (3,808 of 4,061 lines) wrapped around a 253-line
thematic inventory that already states what exists. The inventory is the contract and
stayed; these 73 entries are the story behind it and are reproduced verbatim.
