# Checkpoint archive - dated entries for 2026-09-03 to 2026-09-17

Moved out of [`CURRENT_CHECKPOINT.md`](../../CURRENT_CHECKPOINT.md) on 2026-09-20 so the
active file keeps the last three build days (2026-09-18, 2026-09-19, 2026-09-20) as its
archive rule requires. **This file is evidence, not authority**: an open gate is open
because the active checkpoint's gates tables list it, and every entry here is reproduced
verbatim, newest first (78 entries, Phase 0.20 through Phase 0.33's TJ-1 - the ST and G
packets, the M and Q packets, the WISHLIST sweep, the D1 claimed picks, Phases 0.29 to
0.32, and the trader journal program's planning day).
