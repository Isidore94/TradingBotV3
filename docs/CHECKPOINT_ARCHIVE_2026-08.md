# Checkpoint archive — 2026-08-25 and earlier

Historical entries moved out of [`CURRENT_CHECKPOINT.md`](../CURRENT_CHECKPOINT.md) on
2026-08-27. **This file is evidence, not authority.** Nothing here is an active gate or
an instruction: it is the dated working record of sessions that have already closed.

Why it exists: `CURRENT_CHECKPOINT.md` had grown to 7,901 lines (449 KB, ~115k tokens)
across 113 dated entries, which made the mandatory documentation read in `CLAUDE.md`
roughly 260k tokens before any change could be proposed. No agent reads that — it skims
and then appends, which is what grew the file. The active checkpoint now carries only
the phases with open gates; everything from 2026-08-25 backwards lives here.

Read this file only when you need the history of a specific decision and the active
checkpoint, `CHANGELOG.md` and the governing spec do not answer it. Entries are newest
first and are reproduced verbatim.

---

## Entries 2026-08-26 to 2026-08-31 (moved 2026-09-03)

Moved out of `CURRENT_CHECKPOINT.md` on 2026-09-03 by the F1 docs packet, verbatim,
newest first. The open gates these entries own (#2-#12, #23-#26 and others) stay in
the active checkpoint's gates table; only the narrative moved.
...
## Entries 2026-08-25 and earlier (moved 2026-08-27)
...
[`docs/GUI_REDESIGN_PLAN_2026-08-25.md`](GUI_REDESIGN_PLAN_2026-08-25.md).
...
[`docs/analysis/DAILY_BAR_VOLUME_CLIFF_2026-08-22.md`](analysis/DAILY_BAR_VOLUME_CLIFF_2026-08-22.md),
...
[`docs/analysis/EVIDENCE_AUDIT_2026-08-22.md`](analysis/EVIDENCE_AUDIT_2026-08-22.md),
