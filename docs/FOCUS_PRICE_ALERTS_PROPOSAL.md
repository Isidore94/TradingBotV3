...
Automated gate after merging with the latest Away-mode Drive packet
(2026-08-03): `pytest tests/ -q` → **1806 passed + 5 subtests**;
`scripts/smoke_check.py` → **7/7**. The live check above remains outstanding.
