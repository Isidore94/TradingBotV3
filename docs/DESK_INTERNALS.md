...
## SN - the scanner's hold on the interpreter (2026-09-08 SN5/SN6, 2026-09-12 SN3; SN1/SN2/SN4 open)
...
- **What did not change:** `request_and_detect_bounce`, the RRS passes, `_rebuild_feed`, every detector, threshold, tier, fold and evidence row. SN1-SN3 remain in WISHLIST as ideas until the trader moves them into `plan.md`.
...
- **What did not change:** `request_and_detect_bounce`, `_rebuild_feed`, every detector, threshold, tier, fold and evidence row, and every RRS number the passes produced. SN1, SN2 and SN4 remain in WISHLIST as ideas until the trader moves them into `plan.md`.
