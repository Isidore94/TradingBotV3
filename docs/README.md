...
| [`analysis/PROJECT_PROCESS_REVIEW_2026-09-04.md`](analysis/PROJECT_PROCESS_REVIEW_2026-09-04.md) | Source-backed advisory review of discovery, research, local AI and performance at `f641421`. Corrects earlier link/fallback conclusions; records measured held/overlap gaps, AI grounding issues, scorecard stall and scan costs. No implementation or promotion authorization. |
| [`analysis/LAKE_ASSESSMENT_2026-09-04.md`](analysis/LAKE_ASSESSMENT_2026-09-04.md) | Historical Q1-Q8 lake measurements, with a later correction notice. The audit used the wrong like-link field; zero matches, guaranteed-loss, edge and promotion-readiness conclusions must not be reused. Scripts and saved JSON remain historical and uncorrected. |
| [`SWING_SIMULATOR_INVESTIGATION_2026-09-04.md`](SWING_SIMULATOR_INVESTIGATION_2026-09-04.md) | Historical missing-band investigation (234/27,579 populated daily snapshots). Bridge built; historical feature/outcome repair and gate #59 remain owed. Later review corrects the assertion that no-target paths cannot win: expiry can be profitable. |
...
18. [the overnight run does its deterministic work before it narrates](decisions/0018-deterministic-stage-before-narration.md).
