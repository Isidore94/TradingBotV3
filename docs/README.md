...
| [`SWING_QUALITY_AND_FEEDBACK_PLAN.md`](SWING_QUALITY_AND_FEEDBACK_PLAN.md) | Phase 0.5 R3 — **BUILD AUTHORIZED / IN PROGRESS** by the trader's 2026-08-15 weekend redirect: shadow-only `would_demote` quality classifier, pre-close honesty bundle, dislike-feedback loop; shadow week owed |
| [`DESK_CHART_UNIFICATION_PLAN.md`](DESK_CHART_UNIFICATION_PLAN.md) | ACTIVE spec for Phase 0.5 R4: capture on every chart, painted armed alerts, forming-bar honesty, reviewed-today badge; recovered §6.1 "Not today" armed-alert survival is **BUILT 2026-08-16**, live proof owed |
