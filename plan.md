...
| G4 | **G4.1 + G4.2 BUILT and green on `claude/g4-stale-research-detail`** (tester-first, merged with `main` `68762909` rather than `lead/merge-st`); MERGED to `main` at `18d3f91d`; live gate #80 owed at the next desk restart. **G4.3 stays queued as G4b.** |
| G3 | red tests being written 2026-09-06 |
