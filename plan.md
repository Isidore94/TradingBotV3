...
| G1 Weekend Focus Review | BUILT on `claude/g1-weekend-focus-review` (tester-first); reviewer NO-GO on one blocker (the detail pane went stale after a refresh); fix round running 2026-09-07; gate #82 |
