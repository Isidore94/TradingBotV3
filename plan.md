...
| **0.29** | Pullback alert, trendline break, compression (trader 2026-09-15) | The H1 retester becomes the Pullback alert with M15 150-SMA / M30 75-SMA reclaim, LRSI 80-cross and SMA-retest triggers, auto-armed on claimed D1 picks and swing Focus; three new claim names; a `compressed` chip and a read-only calibration CLI against the trader's compression vetoes before any penalty change; `trendline_break` and `compression_break` tags with a D1 trendline-break event. **PCT-3 BUILT, reviewed (3 rounds) and merged into `claude/pullback-compression-2026-09-15` 2026-09-15 (gates #124-#125 owed); PCT-1 built, merged and review round 2 GO (gates #126-#129 owed); PCT-2 planned. Spec `docs/PULLBACK_COMPRESSION_TRENDLINE_PLAN.md`.** |
...
## Phase 0.29 — Pullback alert, trendline break, compression (trader 2026-09-15) — PCT-3 BUILT and merged into the plan branch (gates #124-#125 owed), PCT-1 merged and review round 2 GO, PCT-2 planned
